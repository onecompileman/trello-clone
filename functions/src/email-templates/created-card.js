function createdCardEmail(cardCreator, userName, card, boardName) {
  return `
                  ...
                  <td bgcolor="#ffffff" style="padding: 40px 30px 40px 30px">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                      ...
                      <tr>
                        ...
                        >
                          <br />
                          <i>${cardCreator}</i> created a card
                          <b>"${card.name}"</b> to the <b>${boardName}</b> board.
                          <br />
                          <br />
                        </td>
                      </tr>
...
exports.createdCardEmail = createdCardEmail;
